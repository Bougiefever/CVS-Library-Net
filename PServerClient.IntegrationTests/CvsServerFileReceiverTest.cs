...
namespace PServerClient.IntegrationTests
{
   ...
   public class CvsServerFileReceiverTest
   {
      ...
      public void TestFixtureSetUp()
      {
         ...
         _root.WorkingDirectory = new DirectoryInfo(@"c:\mydir");
      }
      ...
      private static ICVSItem CreateTestFolderStructure()
      {
         ...
         //ICVSItem module = new Folder(new DirectoryInfo(@"c:\_temp\module"), ":pserver:abougie@gb-aix-q:/usr/local/cvsroot/sandbox", "module");
