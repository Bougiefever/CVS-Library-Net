...
namespace PServerClient.Requests
{
   ...
   /// operation.
   /// </summary>
   public class WatchOffRequest : NoArgRequestBase
   {
      /// <summary>
      /// Initializes a new instance of the <see cref="WatchOffRequest"/> class.
      /// </summary>
      public WatchOffRequest()
      {
      }
      ...
      public WatchOffRequest(IList<string> lines)
         : base(lines)
      {
      }
